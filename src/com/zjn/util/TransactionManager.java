...
public class TransactionManager {
    ...
    public static void startTran() throws SQLException {
        ...
        //--由于一个事务需要执行多条sql，每个sql执行过后都关闭连接，这样一来后续的sql没法执行，所以这个地方改造close方法，使他不能关闭连接
     ...
     * 如果开启过事务，则返回一个改造过getConnection方法的数据源，这个方法改造后每次都返回同一个开启过事务的Conn
     */
